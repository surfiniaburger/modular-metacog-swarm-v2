...
USE_A2A_BENCHMARK=1 BENCH_EVERY_N=3 A2A_BENCH_URL=http://localhost:8004 USE_LITELLM=1 BENCH_LOG_FULL=1 BENCH_NUM_TASKS=10 BENCH_PER_MODEL_MAX_SECONDS=60 OLLAMA_TIMEOUT=30 OLLAMA_RETRIES=2 OLLAMA_SLEEP=0.2 ./launch_gen2.sh
